...
import {
  handleDevListUsers,
  handleJwtFetchApiKey,
} from "../handlers/handle-auth-compat.ts";
...
export const registerRoutes = (app: Application, ctx: AppContext): void => {
  ...
  app.post(
    "/api/v1/users/me/api_key/regenerate",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.patch(
    "/api/v1/users/me/subscriptions/:stream_id",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.get(
    "/api/v1/streams/:stream_id/email_address",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.patch(
    "/api/v1/channel_folders/:folder_id",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.get(
    "/api/v1/messages/:message_id/read_receipts",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.post(
    "/api/v1/messages/:message_id/typing",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.patch(
    "/api/v1/realm/profile_fields/:field_id",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.post(
    ...
    upload.fields([{ name: "filename" }, { name: "file" }]),
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.patch(
    "/api/v1/realm/user_settings_defaults",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.post(
    "/api/v1/realm/test_welcome_bot_custom_message",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.delete(
    "/api/v1/invites/multiuse/:invite_id",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  // --- Mobile Push ---
  app.post(
    "/api/v1/mobile_push/test_notification",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.post(
    "/api/v1/user_groups/:group_id/deactivate",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.get(
    "/api/v1/user_groups/:group_id/members",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.get(
    "/api/v1/user_groups/:group_id/members/:user_id",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.get(
    "/api/v1/user_groups/:group_id/subgroups",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.get(
    "/thumbnail/status/:realm_id_str/:path_id",
    async (req: Request, res: Response, _next: NextFunction) => {
      await handleThumbnailStatusCompat(req, res, ctx);
    },
  );
  ...
  app.get(
    "/user_uploads/:tenant_id/emoji/:emoji_id/:filename",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.get(
    "/user_uploads/:tenant_id/:path_id/:filename",
    async (req: Request, res: Response, _next: NextFunction) => {
      await handleServeFile(req, res, ctx);
    },
  );
  ...
  app.get(
    "/user_uploads/:tenant_id/:path_id",
    async (req: Request, res: Response, _next: NextFunction) => {
      await handleServeFile(req, res, ctx);
    },
  );
  ...
  app.post(
    "/api/v1/external/:integration_name",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.patch(
    "/api/v1/navigation_views/:fragment_head/:fragment_tail/*",
    async (req: Request, res: Response, _next: NextFunction) => {
      await handleUpdateNavigationViewCompat(req, res, ctx);
    },
  );
  ...
  app.patch(
    "/api/v1/navigation_views/:fragment_head/:fragment_tail/:fragment_rest",
    async (req: Request, res: Response, _next: NextFunction) => {
      await handleUpdateNavigationViewCompat(req, res, ctx);
    },
  );
  ...
  app.patch(
    "/api/v1/saved_snippets/:saved_snippet_id",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.patch(
    "/api/v1/scheduled_messages/:scheduled_message_id",
    async (req: Request, res: Response, _next: NextFunction) => {
  ...
  app.patch(
    "/internal/admin/tenants/:tenant_id",
    async (req: Request, res: Response, _next: NextFunction) => {
