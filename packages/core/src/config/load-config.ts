...
export function loadConfig(): ServerConfig {
  ...
  const production = Environment.GetEnvironmentVariable("JOTSTER_PRODUCTION") ?? undefined;
  const devAuthEnabled = Environment.GetEnvironmentVariable("JOTSTER_DEV_AUTH_ENABLED") ?? undefined;
