...
import { removeUserGroupMembers } from "../repo/remove-user-group-members.ts";

export const removeUserGroupMembersDomain = async (
  ...
  await removeUserGroupMembers(options, groupId, userIds);
